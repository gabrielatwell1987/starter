...
for (let i = 0; i < 30; i++) {
  ...
  grave.scale.set(1 + Math.random() * 0.5, 1, 1 + Math.random() * 0.5);
  graves.add(grave);
}
...
// Directional light
const directionalLight = new THREE.DirectionalLight("#86cd44", 1);
 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight("#44ffcc", 6);
const ghost2 = new THREE.PointLight("#44aacc", 6);
const ghost3 = new THREE.PointLight("#4466cc", 6);
